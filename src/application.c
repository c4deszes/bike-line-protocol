...
static void _LINE_API_Init_default(void) {

}
void LINE_API_Init(void) __attribute__((weak,alias("_LINE_API_Init_default")));

static bool _LINE_API_RespondsTo_default(uint16_t request) {
    return false;
}
bool LINE_API_RespondsTo(uint16_t request) __attribute__((weak,alias("_LINE_API_RespondsTo_default")));

static bool _LINE_API_PrepareResponse_default(uint16_t request, uint8_t* size, uint8_t* payload) {
    return false;
}
...
static bool _LINE_API_ListensTo_default(uint16_t request) {
    return false;
}
bool LINE_API_ListensTo(uint16_t request) __attribute__((weak,alias("_LINE_API_ListensTo_default")));

static void _LINE_API_OnRequest_default(uint16_t request, uint8_t size, uint8_t* payload) {
    return;
}
